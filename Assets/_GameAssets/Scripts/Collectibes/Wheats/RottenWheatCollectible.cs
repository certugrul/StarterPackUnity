...
public class RottenWheatCollectible : MonoBehaviour, ICollectible
{
    ...
    public void Collect()
    {
       ...
       _wheatDesingSO.ActiveSprite,
       _wheatDesingSO.PassiveSprite,
       _wheatDesingSO.ActiveWheatSprite,
       _wheatDesingSO.PassiveWheatSprite,
       _wheatDesingSO.ResetBoostDuration
